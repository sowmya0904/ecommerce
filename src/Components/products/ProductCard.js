    ...
    <Grid item xs={12} sm={6} md={3}>
      ...
      <div className="flex items-center justify-between w-full px-2 py-3">
        ...
        style={{backgroundColor:"#3f51b5"}}
          variant="contained"
          onClick={() => {
            navigate("/productdetail/"+props.id, { state: { id: props.id, role:props.role } });
          }}
        >
          Buy
        </Button>
        ...
        {props.role === "admin" && (
          <Button
            ...
            style={{ color: "gray" }}
            onClick={() => {
              navigate("/modifyproduct/"+props.id, { state: { id: props.id } });
            }}
          >
            {" "}
            <EditIcon />
        ...
        {props.role === "admin" && (
          <Button style={{ color: "gray" }} onClick={deleteHandler} data-id={props.id}>
            <DeleteIcon  />
          </Button>
        )}
        </div>
